...
func main() {
	...
	model := tui.NewWithShellCreatorAttacherKillerReconcilerAndResumer(db, settings, tui.TmuxHealth(settings), sessions.CreateShell, client.AttachCommand, sessions.Kill, sessions.Reconcile, sessions.Resume)
